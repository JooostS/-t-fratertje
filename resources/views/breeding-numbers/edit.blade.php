<x-layouts.app title="Kweeknummer wijzigen">
    ...
    <form method="POST" action="{{ route('breeding-numbers.update', $breedingNumber) }}" class="card mt-6 max-w-2xl space-y-4">
        ...
        <x-field name="breeding_number" label="Kweeknummer (NBvV-lidnummer)" :value="$breedingNumber->breeding_number" required maxlength="4" hint="Precies 4 letters en/of cijfers, bijvoorbeeld 1TKY of FR75." />
